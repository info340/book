...
This is particularly useful when using a variable number of elements, or generating elements directly from data (see the [_Props_](#props) section below).
...
```jsx
//TODO: EDIT THIS!!
//Include a prop called `message` with value "Hello property"
let messageA = <MessageItem message="Hello property!" />;

//Specify property using an inline expression
