...
This creates a _one-directional data flow_&mdash;the data values are passed into the parent, which then passes data down to the children (not vice versa). 
