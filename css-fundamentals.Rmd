...
- It is also possible to include CSS code directly in your HTML by embedded it in a `<style>` element in the `<head>`, but this is considered bad practice (keep concerns separated!) and should only be used for quick tests.
