...
- The [**Create React App**](https://create-react-app.dev/) application for scaffolding React apps provides a webserver that is able to transpile React code. This is used when developing React apps (and only then). See [Getting Set Up: Create React App](#create-react-app) for details.
