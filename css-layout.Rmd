...
To use a Flexbox layout, you need to style _two_ different classes of is that you need to style _two_ different classes of elements: a **container** (or **parent**) element that acts as a holder for the **item** (or **child**) elements&mdash;the child elements are _nested_ inside of the parent:
