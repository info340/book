...
<p class="alert alert-danger">This course expects you to already be familiar with utilizing Git and GitHub. For review, see [Git and GitHub](https://info201.github.io/git-basics.html) and [Git Branches and Collaboration](https://info201.github.io/git-branches.html) in the _INFO 201_ course reader. Note that students in the INFO 343 course will be using GitHub and Pull Requests to turn in programming assignments.</p>
