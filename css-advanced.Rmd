...
### Id Selector
It is possible to select HTML elements by their `id` attribute. Every HTML element can have an `id` attribute, and this is most commonly used to create ["bookmark hyperlinks"](https://www.w3.org/TR/html4/struct/links.html#h-12.2.3), which are hyperlinks to a particular location on a page (i.e., that cause the page to scroll down). 

- Unlike the `class` attribute, the value of the `id` attribute must be unique within the page. That is, no two elements can have the same value for their `id` attributes.
...
The `id` attribute is more specific but less flexible than the `class` attribute, and makes it harder to "reuse" your styling. Thus you should _almost always use a class selector instead_, unless you are referring to a single, specific element.
...
You can use the can use the below Code Pen to experiment and practice with these pseudo-classes:

- <p data-height="265" data-theme-id="0" data-slug-hash="yagKEg" data-default-tab="html,css,result" data-user="joelross" data-embed-version="2" data-preview="true" class="codepen">See the Pen <a href="http://codepen.io/joelross/pen/yagKEg/?editors=1100#0">CSS Pseudo-class Practice</a> by Joel Ross (<a href="http://codepen.io/joelross">@joelross</a>) on <a href="http://codepen.io">CodePen</a>.</p>
...
You can use the can use the below Code Pen to experiment and practice with these different units:

- <p data-height="265" data-theme-id="0" data-slug-hash="QKdAaq" data-default-tab="html,css,result" data-user="joelross" data-embed-version="2" class="codepen">See the Pen <a href="http://codepen.io/joelross/pen/QKdAaq/?editors=1100#0">CSS Unit Playground</a> by Joel Ross (<a href="http://codepen.io/joelross">@joelross</a>) on <a href="http://codepen.io">CodePen</a>.</p>
<script async src="//assets.codepen.io/assets/embed/ei.js"></script>
